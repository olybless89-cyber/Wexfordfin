...
const bgSlides = [
  { img: '/images/hero/banking-hall.svg', label: 'Wexfordfin Grand Banking Hall' },
  { img: '/images/hero/atm-gallery.svg', label: 'Wexfordfin ATM Gallery' },
  { img: '/images/hero/customer-care.svg', label: 'Wexfordfin Customer Care Unit' },
  { img: '/images/hero/hq-tower.svg', label: 'Wexfordfin Global HQ — Night' },
];
