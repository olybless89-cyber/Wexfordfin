...
const slides = [
  ...
  {
    img: '/images/hero/banking-hall.svg',
  ...
  {
    img: '/images/hero/customer-care.svg',
    label: 'Wexfordfin Customer Care Unit',
    caption: 'Dedicated support desks and private client lounges — the Wexfordfin brand proudly on every wall.',
    tag: 'Customer Care',
    icon: Landmark,
  },
  {
    img: '/images/hero/hq-tower.svg',
    label: 'Wexfordfin Global HQ',
    caption: 'Our illuminated tower carries WEXFORDFIN high above the city — a beacon of trust.',
    tag: 'Our Buildings',
    icon: Building2,
  },
];
